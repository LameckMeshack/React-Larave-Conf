    ...
    return (
        <div className="roles flex p-8 justify-center align-center">
            <div className="flex flex-col justify-center mx-8">
                ...
                {!showDept && (
                    <ul className="bg-white rounded-lg border bg-green-200 border-gray-200 w-96 text-gray-900">
            ...
            <div className="flex flex-col justify-center">
                ...
                {showDept && (
                    <ul className="bg-white bg-green-200 rounded-lg border border-gray-200 w-96 text-gray-900">
                        <li className="px-6 py-2 border-b border-gray-200 w-full rounded-t-lg text-2xl">
